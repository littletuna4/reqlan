...
pub use extract::{
    analyze_local_symbolic, count_wildcard_matches, extract_indexed_document, path_glob_matches,
    split_wildcard_label, ExtractOptions, WildcardIdeaCandidate, EXTRACT_VERSION,
};
