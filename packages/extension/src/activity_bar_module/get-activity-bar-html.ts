...
export function getActivityBarHtml(webview: vscode.Webview, extensionUri: vscode.Uri): string {
    const nonce = getNonce();
    const baseUri = vscode.Uri.joinPath(extensionUri, 'media', 'webviews', 'activity-bar');
