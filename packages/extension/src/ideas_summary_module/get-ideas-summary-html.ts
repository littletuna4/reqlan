...
/** Svelte webview shell per ["../../../../reqlan rq/extension/presentation/webview.rq"] */
export function getIdeasSummaryHtml(
  ...
  const scriptUri = webview.asWebviewUri(
    vscode.Uri.joinPath(baseUri, "main.js"),
  );
  const styleUri = webview.asWebviewUri(
    vscode.Uri.joinPath(baseUri, "main.css"),
  );
  const csp = [
    "default-src 'none'",
